...
vector<int> const concat(vector<int> &array1, vector<int> &array2) {
  /*
...
vector<int> const slice(vector<int> &array, int start, int end) {
  /*
...
vector<int> mergeAll(vector<int> &left_array, vector<int> &right_array) {
  ...
  while ((left_index < left_array.size()) and
         (right_index < right_array.size())) {
...
vector<int> const mergeSort(vector<int> &array) {
  /*
